...
public class ModifyTask {
	...
	static void createtask()
	{
		try
		{
			oPage.getNewTaskClick().click();
			Thread.sleep(2000);
			oPage.getCreateNewTask().click();
			Thread.sleep(2000);
			oPage.getEnterTaskName().sendKeys("T1");
			Thread.sleep(2000);
			oPage.getSaveTaskName().click();
			Thread.sleep(2000);
		}
		catch(Exception e)
		{
	...
	static void modifytask()
	{
		try
		{
			oPage.getClickOnTaskTomodify().click();
			Thread.sleep(2000);
			oPage.getDescriptionToModifyTask().sendKeys("Something has changed");
			Thread.sleep(2000);
			oPage.getAfterModifiedTask().click();
			Thread.sleep(2000);
		}
		catch(Exception e)
		{
